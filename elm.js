...
var author$project$Main$AbstractCircle = F3(
	function (cx, cy, r) {
		return {R: cx, S: cy, ah: r};
	});
var author$project$Main$intervalSize = 2;
var author$project$Main$radius = 1;
...
var author$project$Main$graphWithCircles = function (graphFunc) {
	var mapList = A2(
		elm$core$List$map,
		function (n) {
			return n;
	...
	var mapFunction = function (n) {
		return A3(
			author$project$Main$AbstractCircle,
			n * author$project$Main$intervalSize,
			author$project$Main$graphHeight - graphFunc(n),
...
var author$project$Main$makeSvgCircle = function (circleData) {
	return A2(
		elm$svg$Svg$circle,
		_List_fromArray(
			[
				elm$svg$Svg$Attributes$cx(
				elm$core$String$fromFloat(circleData.R)),
				elm$svg$Svg$Attributes$cy(
				elm$core$String$fromFloat(circleData.S)),
				elm$svg$Svg$Attributes$r(
				elm$core$String$fromFloat(circleData.ah))
			]),
		_List_Nil);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								'Inner: ' + elm$core$String$fromFloat(model.t))
							])),
						A2(
						elm$html$Html$input,
						_List_fromArray(
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								'Outer: ' + elm$core$String$fromFloat(model.u))
							])),
						A2(
						elm$html$Html$input,
						_List_fromArray(
							[
								elm$html$Html$Attributes$placeholder(''),
								elm$html$Html$Attributes$value(
								elm$core$String$fromFloat(model.u)),
				...
				A2(
					elm$core$List$map,
					author$project$Main$makeSvgCircle,
					author$project$Main$graphWithCircles(
						function (n) {
							return (model.u * model.J(
								elm$core$Basics$degrees(model.t) * n)) + (author$project$Main$graphHeight / 2);
						})))
			]));
};
